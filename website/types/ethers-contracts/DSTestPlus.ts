...
export interface DSTestPlusInterface extends utils.Interface {
  functions: {
...
export interface DSTestPlus extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DSTestPlusInterface;
  ...
  filters: {
    "log(string)"(undefined?: null): logEventFilter;
    log(undefined?: null): logEventFilter;

    "log_address(address)"(undefined?: null): log_addressEventFilter;
    log_address(undefined?: null): log_addressEventFilter;

    "log_bytes(bytes)"(undefined?: null): log_bytesEventFilter;
    log_bytes(undefined?: null): log_bytesEventFilter;

    "log_bytes32(bytes32)"(undefined?: null): log_bytes32EventFilter;
    log_bytes32(undefined?: null): log_bytes32EventFilter;

    "log_int(int256)"(undefined?: null): log_intEventFilter;
    log_int(undefined?: null): log_intEventFilter;
    ...
    "log_string(string)"(undefined?: null): log_stringEventFilter;
    log_string(undefined?: null): log_stringEventFilter;

    "log_uint(uint256)"(undefined?: null): log_uintEventFilter;
    log_uint(undefined?: null): log_uintEventFilter;

    "logs(bytes)"(undefined?: null): logsEventFilter;
    logs(undefined?: null): logsEventFilter;
  };
