...
export interface DebtTokenInterface extends utils.Interface {
  functions: {
    ...
    "setNiftyBank(address)": FunctionFragment;
...
export interface DebtToken extends BaseContract {
  ...
  callStatic: {
    ...
    mint(_borrower: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setNiftyBank(_niftyBank: string, overrides?: CallOverrides): Promise<void>;
